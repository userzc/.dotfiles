...
(defvar lista-paquetes-instalados
  '(ac-js2 ac-math ag all-the-icons auctex auto-complete avy
           ...
           flycheck-yamllint gitconfig-mode gitignore-mode
           google-c-style google-contacts gradle-mode gradle-mode
           groovy-mode hgignore-mode ido-better-flex jasminejs-mode
           java-snippets javadoc-lookup js-doc js2-mode js2-refactor
           litable lorem-ipsum magit makey mark-more-like-this
           markdown-mode monky monokai-theme multi-term
           multiple-cursors neotree nose oauth2 org-bullets popup
           powerline powershell projectile purty-mode python-django
...
(setq el-get-paquetes-instalados
      '(bookmark+ dired-details+ dired+ icicles icomplete+ ox-ioslide
      ox-twbs))
