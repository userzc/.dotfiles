...
(defvar lista-paquetes-instalados
  '(ac-js2 ac-math ag all-the-icons auctex auto-complete avy
        badwolf-theme c-eldoc cedit cl-lib command-log-mode company
        dash deferred dired-details editorconfig ein emmet-mode
        enclose exec-path-from-shell expand-region f feature-mode
        flycheck-yamllint gitconfig-mode gitignore-mode google-c-style
        google-contacts gradle-mode gradle-mode groovy-mode
        hgignore-mode ido-better-flex jasminejs-mode java-snippets
        javadoc-lookup js-doc js2-mode js2-refactor litable
        lorem-ipsum magit makey mark-more-like-this markdown-mode
        monky monokai-theme multi-term multiple-cursors neotree nose
        oauth2 org-bullets poly-markdown popup powerline powershell
        projectile purty-mode python-django rainbow-delimiters
        rainbow-mode request restclient scss-mode smart-mode-line
        smart-tab smartparens spacegray-theme sr-speedbar
        sublime-themes tango-2-theme tangotango-theme textile-mode
        tide virtualenvwrapper web-mode websocket wgrep wgrep-ag
...
(setq el-get-paquetes-instalados
      '(bookmark+ dired-details+ icicles icomplete+ ox-ioslide
      ox-twbs))
