...
(let ((loads (get 'html-chklnk 'custom-loads))) (if (member '"../../../../../.emacs.d/lisp/nxhtml/nxhtml/html-chklnk" loads) nil (put 'html-chklnk 'custom-loads (cons '"../../../../../.emacs.d/lisp/nxhtml/nxhtml/html-chklnk" loads))))
...
(let ((loads (get 'html-pagetoc 'custom-loads))) (if (member '"../../../../../.emacs.d/lisp/nxhtml/nxhtml/html-pagetoc" loads) nil (put 'html-pagetoc 'custom-loads (cons '"../../../../../.emacs.d/lisp/nxhtml/nxhtml/html-pagetoc" loads))))

(nxhtml-autoload 'html-pagetoc-insert-toc `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/html-pagetoc" nxhtml-install-dir) "\
...
(nxhtml-autoload 'html-pagetoc-rebuild-toc `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/html-pagetoc" nxhtml-install-dir) "\
...
(let ((loads (get 'html-site 'custom-loads))) (if (member '"../../../../../.emacs.d/lisp/nxhtml/nxhtml/html-site" loads) nil (put 'html-site 'custom-loads (cons '"../../../../../.emacs.d/lisp/nxhtml/nxhtml/html-site" loads))))

(nxhtml-autoload 'html-site-edit-sites `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/html-site" nxhtml-install-dir) "\
Edit the list of sites.
This is the same as customizing option `html-site-list'.

\(fn)" t nil)

(nxhtml-autoload 'html-site-buffer-or-dired-file-name `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/html-site" nxhtml-install-dir) "\
Return buffer file name or file pointed to in dired.

\(fn)" nil nil)

(nxhtml-autoload 'html-site-set-site `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/html-site" nxhtml-install-dir) "\


\(fn NAME)" t nil)

(nxhtml-autoload 'html-site-dired-current `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/html-site" nxhtml-install-dir) "\
Open `dired' in current site top directory.

\(fn)" t nil)

(nxhtml-autoload 'html-site-find-file `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/html-site" nxhtml-install-dir) "\
Find file in current site.

\(fn)" t nil)

(nxhtml-autoload 'html-site-rgrep `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/html-site" nxhtml-install-dir) "\
Search current site's files with `rgrep'.
See `rgrep' for the arguments REGEXP and FILES.

\(fn REGEXP FILES)" t nil)

(nxhtml-autoload 'html-site-query-replace `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/html-site" nxhtml-install-dir) "\
...
(let ((loads (get 'html-toc 'custom-loads))) (if (member '"../../../../../.emacs.d/lisp/nxhtml/nxhtml/html-toc" loads) nil (put 'html-toc 'custom-loads (cons '"../../../../../.emacs.d/lisp/nxhtml/nxhtml/html-toc" loads))))
...
(let ((loads (get 'html-upl 'custom-loads))) (if (member '"../../../../../.emacs.d/lisp/nxhtml/nxhtml/html-upl" loads) nil (put 'html-upl 'custom-loads (cons '"../../../../../.emacs.d/lisp/nxhtml/nxhtml/html-upl" loads))))

(nxhtml-autoload 'html-upl-upload-site-with-toc `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/html-upl" nxhtml-install-dir) "\


\(fn)" t nil)

(nxhtml-autoload 'html-upl-upload-site `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/html-upl" nxhtml-install-dir) "\


\(fn)" t nil)

(nxhtml-autoload 'html-upl-remote-dired `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/html-upl" nxhtml-install-dir) "\
Start dired for remote directory or its parent/ancestor.

\(fn DIRNAME)" t nil)

(nxhtml-autoload 'html-upl-upload-file `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/html-upl" nxhtml-install-dir) "\
Upload a single file in a site.
For the definition of a site see `html-site-current'.

\(fn FILENAME)" t nil)

(nxhtml-autoload 'html-upl-edit-remote-file `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/html-upl" nxhtml-install-dir) "\


\(fn)" t nil)

(nxhtml-autoload 'html-upl-edit-remote-file-with-toc `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/html-upl" nxhtml-install-dir) "\


\(fn)" t nil)

(nxhtml-autoload 'html-upl-ediff-file `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/html-upl" nxhtml-install-dir) "\
...
(let ((loads (get 'html-wtoc 'custom-loads))) (if (member '"../../../../../.emacs.d/lisp/nxhtml/nxhtml/html-wtoc" loads) nil (put 'html-wtoc 'custom-loads (cons '"../../../../../.emacs.d/lisp/nxhtml/nxhtml/html-wtoc" loads))))
...
(let ((loads (get 'nxhtml 'custom-loads))) (if (member '"../../../../../.emacs.d/lisp/nxhtml/nxhtml/nxhtml" loads) nil (put 'nxhtml 'custom-loads (cons '"../../../../../.emacs.d/lisp/nxhtml/nxhtml/nxhtml" loads))))

(nxhtml-autoload 'nxhtml-customize `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/nxhtml" nxhtml-install-dir) "\
Customize nXhtml.

\(fn)" t nil)

(nxhtml-autoload 'nxhtml-features-check `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/nxhtml" nxhtml-install-dir) "\
...
(nxhtml-autoload 'nxhtml-report-bug `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/nxhtml-bug" nxhtml-install-dir) "\
...
(nxhtml-autoload 'mumamo-switch-to-other-html `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/nxhtml-menu" nxhtml-install-dir) "\


\(fn)" t nil)

(nxhtml-autoload 'nxhtml-edit-with-gimp `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/nxhtml-menu" nxhtml-install-dir) "\
Edit with GIMP buffer or file at point.

\(fn)" t nil)

(nxhtml-autoload 'nxhtml-browse-file `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/nxhtml-menu" nxhtml-install-dir) "\
View file in web browser.

\(fn FILE)" t nil)

(nxhtml-autoload 'nxhtml-browse-region `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/nxhtml-menu" nxhtml-install-dir) "\
...
(nxhtml-custom-autoload 'nxhtml-menu-mode '../../../../../.emacs.d/lisp/nxhtml/nxhtml/nxhtml-menu nil)

(nxhtml-autoload 'nxhtml-menu-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/nxhtml-menu" nxhtml-install-dir) "\
...
(nxhtml-autoload 'nxhtml-overview `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/nxhtml-menu" nxhtml-install-dir) "\
...
(nxhtml-autoload 'nxhtml-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/nxhtml-mode" nxhtml-install-dir) "\
...
(nxhtml-autoload 'nxhtml-short-tag-help `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/nxhtml-mode" nxhtml-install-dir) "\
Display description of tag TAG.  If TAG is omitted, try tag at point.

\(fn TAG)" t nil)

(when (fboundp 'nxml-mode)
(nxhtml-autoload 'nxhtml-validation-header-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/nxhtml-mode" nxhtml-install-dir) "\
...
(nxhtml-autoload 'nxhtml-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/nxhtml-mumamo" nxhtml-install-dir) "\
...
(nxhtml-autoload 'embperl-nxhtml-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/nxhtml-mumamo" nxhtml-install-dir) "\
Turn on multiple major modes for Embperl files with main mode `nxhtml-mode'.
This also covers inlined style and javascript." t)

(nxhtml-autoload 'django-nxhtml-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/nxhtml-mumamo" nxhtml-install-dir) "\
Turn on multiple major modes for Django with main mode `nxhtml-mode'.
This also covers inlined style and javascript." t)

(nxhtml-autoload 'mason-nxhtml-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/nxhtml-mumamo" nxhtml-install-dir) "\
Turn on multiple major modes for Mason using main mode `nxhtml-mode'.
This covers inlined style and javascript." t)

(nxhtml-autoload 'genshi-nxhtml-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/nxhtml-mumamo" nxhtml-install-dir) "\
Turn on multiple major modes for Genshi with main mode `nxhtml-mode'.
This also covers inlined style and javascript." t)

(nxhtml-autoload 'mjt-nxhtml-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/nxhtml-mumamo" nxhtml-install-dir) "\
Turn on multiple major modes for MJT with main mode `nxhtml-mode'.
This also covers inlined style and javascript." t)

(nxhtml-autoload 'smarty-nxhtml-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/nxhtml-mumamo" nxhtml-install-dir) "\
Turn on multiple major modes for Smarty with main mode `nxhtml-mode'.
This also covers inlined style and javascript." t)

(nxhtml-autoload 'gsp-nxhtml-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/nxhtml-mumamo" nxhtml-install-dir) "\
Turn on multiple major modes for GSP with main mode `nxhtml-mode'.
This also covers inlined style and javascript." t)

(nxhtml-autoload 'jsp-nxhtml-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/nxhtml-mumamo" nxhtml-install-dir) "\
Turn on multiple major modes for JSP with main mode `nxhtml-mode'.
This also covers inlined style and javascript." t)

(nxhtml-autoload 'eruby-nxhtml-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/nxhtml-mumamo" nxhtml-install-dir) "\
Turn on multiple major modes for eRuby with main mode `nxhtml-mode'.
This also covers inlined style and javascript." t)

(nxhtml-autoload 'asp-nxhtml-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/nxhtml-mumamo" nxhtml-install-dir) "\
Turn on multiple major modes for ASP with main mode `nxhtml-mode'.
This also covers inlined style and javascript." t)

(nxhtml-autoload 'mako-nxhtml-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/nxhtml-mumamo" nxhtml-install-dir) "\
...
(let ((loads (get 'nxml-where 'custom-loads))) (if (member '"../../../../../.emacs.d/lisp/nxhtml/nxhtml/nxml-where" loads) nil (put 'nxml-where 'custom-loads (cons '"../../../../../.emacs.d/lisp/nxhtml/nxhtml/nxml-where" loads))))

(nxhtml-autoload 'nxml-where-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/nxml-where" nxhtml-install-dir) "\
...
(nxhtml-custom-autoload 'nxml-where-global-mode '../../../../../.emacs.d/lisp/nxhtml/nxhtml/nxml-where nil)

(nxhtml-autoload 'nxml-where-global-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/nxml-where" nxhtml-install-dir) "\
...
(nxhtml-autoload 'rncdl-update-html5 `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/rncdl" nxhtml-install-dir) "\
...
(nxhtml-autoload 'rngalt-set-validation-header `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/rngalt" nxhtml-install-dir) "\
...
(let ((loads (get 'tidy 'custom-loads))) (if (member '"../../../../../.emacs.d/lisp/nxhtml/nxhtml/tidy-xhtml" loads) nil (put 'tidy 'custom-loads (cons '"../../../../../.emacs.d/lisp/nxhtml/nxhtml/tidy-xhtml" loads))))

(nxhtml-autoload 'tidy-build-menu `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/tidy-xhtml" nxhtml-install-dir) "\
...
(nxhtml-autoload 'xhtml-help-show-css-ref `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/xhtml-help" nxhtml-install-dir) "\
Show CSS reference for CSS property name at point.

\(fn)" t nil)

(nxhtml-autoload 'xhtml-help-tag-at-point `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/xhtml-help" nxhtml-install-dir) "\
Get xhtml tag name at or before point.

\(fn)" nil nil)

(nxhtml-autoload 'xhtml-help-show-tag-ref `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml/xhtml-help" nxhtml-install-dir) "\
Show xhtml reference for tag name at or before point.

\(fn)" t nil)

(let ((loads (get 'xhtml-help 'custom-loads))) (if (member '"../../../../../.emacs.d/lisp/nxhtml/nxhtml/xhtml-help" loads) nil (put 'xhtml-help 'custom-loads (cons '"../../../../../.emacs.d/lisp/nxhtml/nxhtml/xhtml-help" loads))))
...
(nxhtml-autoload 'nxhtmlmaint-start-byte-compilation `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtmlmaint" nxhtml-install-dir) "\
...
(nxhtml-autoload 'nxhtmlmaint-byte-recompile `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtmlmaint" nxhtml-install-dir) "\
...
(nxhtml-autoload 'nxhtmlmaint-byte-uncompile-all `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtmlmaint" nxhtml-install-dir) "\
...
(nxhtml-autoload 'amrita-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/related/amrita" nxhtml-install-dir) "\
...
(nxhtml-custom-autoload 'csharp-mode-hook '../../../../../.emacs.d/lisp/nxhtml/related/csharp-mode t)

(nxhtml-autoload 'csharp-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/related/csharp-mode" nxhtml-install-dir) "\
...
(nxhtml-autoload 'django-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/related/django" nxhtml-install-dir) "\
Simple Django mode for use with mumamo.
This mode only provides syntax highlighting.

\(fn)" t nil)

(nxhtml-autoload 'django-variable-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/related/django" nxhtml-install-dir) "\
...
(nxhtml-custom-autoload 'flymake-global-mode '../../../../../.emacs.d/lisp/nxhtml/related/flymake-files nil)

(nxhtml-autoload 'flymake-global-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/related/flymake-files" nxhtml-install-dir) "\
...
(let ((loads (get 'flymake-for-js 'custom-loads))) (if (member '"../../../../../.emacs.d/lisp/nxhtml/related/flymake-for-js" loads) nil (put 'flymake-for-js 'custom-loads (cons '"../../../../../.emacs.d/lisp/nxhtml/related/flymake-for-js" loads))))
...
(nxhtml-autoload 'iss-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/related/iss-mode" nxhtml-install-dir) "\
...
(nxhtml-autoload 'iss-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/related/iss-mumamo" nxhtml-install-dir) "\
...
(nxhtml-autoload 'moz-minor-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/related/moz" nxhtml-install-dir) "\
...
(nxhtml-autoload 'inferior-moz-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/related/moz" nxhtml-install-dir) "\
Major mode for interacting with Firefox via MozRepl.

\(fn)" t nil)

(nxhtml-autoload 'inferior-moz-stop-process `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/related/moz" nxhtml-install-dir) "\
Stop what `inferior-moz-start-process' started.

\(fn)" t nil)

(nxhtml-autoload 'inferior-moz-start-process `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/related/moz" nxhtml-install-dir) "\
...
(nxhtml-autoload 'mozadd-refresh-edited-on-save-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/related/mozadd" nxhtml-install-dir) "\
...
(nxhtml-custom-autoload 'global-mozadd-refresh-edited-on-save-mode '../../../../../.emacs.d/lisp/nxhtml/related/mozadd nil)

(nxhtml-autoload 'global-mozadd-refresh-edited-on-save-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/related/mozadd" nxhtml-install-dir) "\
...
(nxhtml-autoload 'mozadd-mirror-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/related/mozadd" nxhtml-install-dir) "\
...
(let ((loads (get 'php 'custom-loads))) (if (member '"../../../../../.emacs.d/lisp/nxhtml/related/php-mode" loads) nil (put 'php 'custom-loads (cons '"../../../../../.emacs.d/lisp/nxhtml/related/php-mode" loads))))

(defvar php-file-patterns '("\\.php[s34]?\\'" "\\.phtml\\'" "\\.inc\\'") "\
List of file patterns for which to automatically invoke `php-mode'.")

(nxhtml-custom-autoload 'php-file-patterns '../../../../../.emacs.d/lisp/nxhtml/related/php-mode nil)

(nxhtml-autoload 'php-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/related/php-mode" nxhtml-install-dir) "\
...
(let ((loads (get 'smarty 'custom-loads))) (if (member '"../../../../../.emacs.d/lisp/nxhtml/related/smarty-mode" loads) nil (put 'smarty 'custom-loads (cons '"../../../../../.emacs.d/lisp/nxhtml/related/smarty-mode" loads))))

(nxhtml-autoload 'smarty-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/related/smarty-mode" nxhtml-install-dir) "\
Smarty Mode
***********
...
(nxhtml-autoload 'tt-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/related/tt-mode" nxhtml-install-dir) "\
...
(nxhtml-autoload 'visual-basic-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/related/visual-basic-mode" nxhtml-install-dir) "\
...
(nxhtml-autoload 'ertn-deftest `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/tests/ertn" nxhtml-install-dir) "\
...
(nxhtml-autoload 'nxhtmltest-run-Q `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/tests/nxhtmltest-Q" nxhtml-install-dir) "\
...
(nxhtml-autoload 'nxhtmltest-run-indent `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/tests/nxhtmltest-suites" nxhtml-install-dir) "\
Run indentation tests.

\(fn)" t nil)

(nxhtml-autoload 'nxhtmltest-run `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/tests/nxhtmltest-suites" nxhtml-install-dir) "\
...
(nxhtml-autoload 'anchored-transpose `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/anchored-transpose" nxhtml-install-dir) "\
...
(nxhtml-autoload 'set-secondary-selection `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/anchored-transpose" nxhtml-install-dir) "\
Set the secondary selection to the current region.
This must be bound to a mouse drag event.

\(fn BEG END)" t nil)

(nxhtml-autoload 'cancel-secondary-selection `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/anchored-transpose" nxhtml-install-dir) "\
...
(let ((loads (get 'appmenu 'custom-loads))) (if (member '"../../../../../.emacs.d/lisp/nxhtml/util/appmenu" loads) nil (put 'appmenu 'custom-loads (cons '"../../../../../.emacs.d/lisp/nxhtml/util/appmenu" loads))))

(nxhtml-autoload 'appmenu-add `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/appmenu" nxhtml-install-dir) "\
...
(nxhtml-custom-autoload 'appmenu-mode '../../../../../.emacs.d/lisp/nxhtml/util/appmenu nil)

(nxhtml-autoload 'appmenu-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/appmenu" nxhtml-install-dir) "\
...
(let ((loads (get 'as-external 'custom-loads))) (if (member '"../../../../../.emacs.d/lisp/nxhtml/util/as-external" loads) nil (put 'as-external 'custom-loads (cons '"../../../../../.emacs.d/lisp/nxhtml/util/as-external" loads))))

(nxhtml-autoload 'as-external-for-xhtml `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/as-external" nxhtml-install-dir) "\
...
(nxhtml-autoload 'as-external-for-mail-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/as-external" nxhtml-install-dir) "\
...
(nxhtml-autoload 'as-external-check-contents `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/as-external" nxhtml-install-dir) "\
Try to guess the file contents.

\(fn)" nil nil)

(nxhtml-autoload 'as-external-for-el-files `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/as-external" nxhtml-install-dir) "\
Setup for Firefox addon It's All Text to edit MediaWikis.

\(fn)" t nil)

(nxhtml-autoload 'as-external-for-wiki `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/as-external" nxhtml-install-dir) "\
Setup for Firefox addon It's All Text to edit MediaWikis.
...
(nxhtml-custom-autoload 'as-external-mode '../../../../../.emacs.d/lisp/nxhtml/util/as-external nil)

(nxhtml-autoload 'as-external-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/as-external" nxhtml-install-dir) "\
...
(nxhtml-autoload 'bibhlp `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/bibhlp" nxhtml-install-dir) "\
...
(nxhtml-autoload 'bibhlp-goto-citeulike `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/bibhlp" nxhtml-install-dir) "\
...
(nxhtml-autoload 'bibhlp-copy-link-title-at-point `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/bibhlp" nxhtml-install-dir) "\
Copy `org-mode' link at point title to clipboard.

\(fn)" nil nil)

(nxhtml-autoload 'bibhlp-scopus-by-doi `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/bibhlp" nxhtml-install-dir) "\
...
(nxhtml-autoload 'buffer-bg-set-color `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/buffer-bg" nxhtml-install-dir) "\
...
(nxhtml-autoload 'chartg-complete `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/chartg" nxhtml-install-dir) "\


\(fn)" t nil)

(nxhtml-autoload 'chartg-make-chart `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/chartg" nxhtml-install-dir) "\
...
(let ((loads (get 'css-color 'custom-loads))) (if (member '"../../../../../.emacs.d/lisp/nxhtml/util/css-color" loads) nil (put 'css-color 'custom-loads (cons '"../../../../../.emacs.d/lisp/nxhtml/util/css-color" loads))))

(nxhtml-autoload 'css-color-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/css-color" nxhtml-install-dir) "\
...
(nxhtml-custom-autoload 'css-color-global-mode '../../../../../.emacs.d/lisp/nxhtml/util/css-color nil)

(nxhtml-autoload 'css-color-global-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/css-color" nxhtml-install-dir) "\
...
(nxhtml-autoload 'css-color-test `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/css-color" nxhtml-install-dir) "\
...
(nxhtml-autoload 'css-palette-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/css-palette" nxhtml-install-dir) "\
...
(let ((loads (get 'css-palette 'custom-loads))) (if (member '"../../../../../.emacs.d/lisp/nxhtml/util/css-palette" loads) nil (put 'css-palette 'custom-loads (cons '"../../../../../.emacs.d/lisp/nxhtml/util/css-palette" loads))))
...
(nxhtml-custom-autoload 'css-palette-global-mode '../../../../../.emacs.d/lisp/nxhtml/util/css-palette nil)

(nxhtml-autoload 'css-palette-global-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/css-palette" nxhtml-install-dir) "\
...
(nxhtml-autoload 'customize-for-new-user `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/cus-new-user" nxhtml-install-dir) "\
Show special customization page for new user.

\(fn &optional NAME)" t nil)

(nxhtml-autoload 'cusnu-export-my-skin-options `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/cus-new-user" nxhtml-install-dir) "\
...
(nxhtml-autoload 'ediff-url `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ediff-url" nxhtml-install-dir) "\
...
(nxhtml-custom-autoload 'google-chrome-server-mode '../../../../../.emacs.d/lisp/nxhtml/util/edit-server nil)

(nxhtml-autoload 'google-chrome-server-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/edit-server" nxhtml-install-dir) "\
...
(nxhtml-autoload 'ffip-set-current-project `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ffip" nxhtml-install-dir) "\
...
(nxhtml-autoload 'ffip-find-file-in-dirtree `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ffip" nxhtml-install-dir) "\
...
(let ((loads (get 'fold-dwim 'custom-loads))) (if (member '"../../../../../.emacs.d/lisp/nxhtml/util/fold-dwim" loads) nil (put 'fold-dwim 'custom-loads (cons '"../../../../../.emacs.d/lisp/nxhtml/util/fold-dwim" loads))))

(nxhtml-autoload 'fold-dwim-toggle `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/fold-dwim" nxhtml-install-dir) "\
...
(nxhtml-custom-autoload 'fold-dwim-mode '../../../../../.emacs.d/lisp/nxhtml/util/fold-dwim nil)

(nxhtml-autoload 'fold-dwim-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/fold-dwim" nxhtml-install-dir) "\
Key binding for `fold-dwim-toggle'.

\(fn &optional ARG)" t nil)

(nxhtml-autoload 'fold-dwim-unhide-hs-and-outline `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/fold-dwim" nxhtml-install-dir) "\
...
(nxhtml-autoload 'fold-dwim-turn-on-hs-and-hide `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/fold-dwim" nxhtml-install-dir) "\
...
(nxhtml-autoload 'fold-dwim-turn-on-outline-and-hide-all `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/fold-dwim" nxhtml-install-dir) "\
...
(let ((loads (get 'foldit 'custom-loads))) (if (member '"../../../../../.emacs.d/lisp/nxhtml/util/foldit" loads) nil (put 'foldit 'custom-loads (cons '"../../../../../.emacs.d/lisp/nxhtml/util/foldit" loads))))

(nxhtml-autoload 'foldit-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/foldit" nxhtml-install-dir) "\
...
(nxhtml-custom-autoload 'foldit-global-mode '../../../../../.emacs.d/lisp/nxhtml/util/foldit nil)

(nxhtml-autoload 'foldit-global-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/foldit" nxhtml-install-dir) "\
...
(let ((loads (get 'gimpedit 'custom-loads))) (if (member '"../../../../../.emacs.d/lisp/nxhtml/util/gimpedit" loads) nil (put 'gimpedit 'custom-loads (cons '"../../../../../.emacs.d/lisp/nxhtml/util/gimpedit" loads))))

(nxhtml-autoload 'gimpedit-edit-file `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/gimpedit" nxhtml-install-dir) "\
Edit IMAGE-FILE with GIMP.
See also `gimpedit-edit-file'.

\(fn IMAGE-FILE &optional EXTRA-ARGS)" t nil)

(nxhtml-autoload 'gimpedit-edit-buffer `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/gimpedit" nxhtml-install-dir) "\
...
(nxhtml-autoload 'gimpedit-can-edit `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/gimpedit" nxhtml-install-dir) "\
...
(nxhtml-autoload 'gpl-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/gpl" nxhtml-install-dir) "\
...
(nxhtml-custom-autoload 'hfyview-quick-print-in-files-menu '../../../../../.emacs.d/lisp/nxhtml/util/hfyview nil)

(nxhtml-autoload 'hfyview-buffer `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/hfyview" nxhtml-install-dir) "\
...
(nxhtml-autoload 'hfyview-region `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/hfyview" nxhtml-install-dir) "\
Convert region to html preserving faces and show in web browser.
With command prefix ARG also show html source in other window.

\(fn ARG)" t nil)

(nxhtml-autoload 'hfyview-window `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/hfyview" nxhtml-install-dir) "\
Convert window to html preserving faces and show in web browser.
With command prefix ARG also show html source in other window.

\(fn ARG)" t nil)

(nxhtml-autoload 'hfyview-frame `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/hfyview" nxhtml-install-dir) "\
...
(let ((loads (get 'hl-needed 'custom-loads))) (if (member '"../../../../../.emacs.d/lisp/nxhtml/util/hl-needed" loads) nil (put 'hl-needed 'custom-loads (cons '"../../../../../.emacs.d/lisp/nxhtml/util/hl-needed" loads))))
...
(nxhtml-custom-autoload 'hl-needed-mode '../../../../../.emacs.d/lisp/nxhtml/util/hl-needed nil)

(nxhtml-autoload 'hl-needed-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/hl-needed" nxhtml-install-dir) "\
...
(let ((loads (get 'html-write 'custom-loads))) (if (member '"../../../../../.emacs.d/lisp/nxhtml/util/html-write" loads) nil (put 'html-write 'custom-loads (cons '"../../../../../.emacs.d/lisp/nxhtml/util/html-write" loads))))

(nxhtml-autoload 'html-write-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/html-write" nxhtml-install-dir) "\
...
(nxhtml-autoload 'http-post-simple `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/http-post-simple" nxhtml-install-dir) "\
...
(nxhtml-autoload 'http-post-simple-multipart `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/http-post-simple" nxhtml-install-dir) "\
...
(nxhtml-autoload 'idxdoc-index-files `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/idxdoc" nxhtml-install-dir) "\
Index files.
...
(nxhtml-autoload 'idxdoc-search `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/idxdoc" nxhtml-install-dir) "\
...
(nxhtml-autoload 'idxdocindex-search `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/idxdocindex" nxhtml-install-dir) "\
...
(nxhtml-autoload 'idxgds-query-url-p `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/idxgds" nxhtml-install-dir) "\


\(fn)" nil nil)

(nxhtml-autoload 'idxgds-search `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/idxgds" nxhtml-install-dir) "\


\(fn SEARCH-PATT FILE-PATTS ROOT)" nil nil)

(nxhtml-autoload 'idxgds-search-adv `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/idxgds" nxhtml-install-dir) "\
...
(nxhtml-autoload 'idxsearch `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/idxsearch" nxhtml-install-dir) "\
...
(nxhtml-autoload 'idxwds-search `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/idxsql" nxhtml-install-dir) "\
...
(let ((loads (get 'inlimg 'custom-loads))) (if (member '"../../../../../.emacs.d/lisp/nxhtml/util/inlimg" loads) nil (put 'inlimg 'custom-loads (cons '"../../../../../.emacs.d/lisp/nxhtml/util/inlimg" loads))))

(nxhtml-autoload 'inlimg-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/inlimg" nxhtml-install-dir) "\
...
(nxhtml-custom-autoload 'inlimg-global-mode '../../../../../.emacs.d/lisp/nxhtml/util/inlimg nil)

(nxhtml-autoload 'inlimg-global-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/inlimg" nxhtml-install-dir) "\
...
(nxhtml-autoload 'inlimg-toggle-display `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/inlimg" nxhtml-install-dir) "\
Toggle display of image at point POINT.
See also the command `inlimg-mode'.

\(fn POINT)" t nil)

(nxhtml-autoload 'inlimg-toggle-slicing `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/inlimg" nxhtml-install-dir) "\
...
(nxhtml-autoload 'jsut-plovr-dev-info `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/js-utils" nxhtml-install-dir) "\
Get info for how to start plovr in dev mode for PLOVR-FILE.

\(fn PLOVR-FILE)" t nil)

(nxhtml-autoload 'jsut-plovr-edit-conf `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/js-utils" nxhtml-install-dir) "\
Switch between the plovr config file and the js file.
JS-FILE is the one of those and default to current buffer file.

\(fn JS-FILE)" t nil)

(nxhtml-autoload 'jsut-plovr-compile `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/js-utils" nxhtml-install-dir) "\
Compile JS-FILE with plovr/closure compiler.

\(fn JS-FILE)" t nil)

(nxhtml-autoload 'jsut-bookmarkletify `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/js-utils" nxhtml-install-dir) "\
...
(nxhtml-autoload 'jsut-jquery-include-it `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/js-utils" nxhtml-install-dir) "\


\(fn BUFFER)" t nil)

(nxhtml-autoload 'jsut-jquery-create-bookmarklet-file `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/js-utils" nxhtml-install-dir) "\
Create jQuery bookmarklet JavaScript file template.
To make a bookmarklet for this you can use `jsut-jquery-mk-bookmarklet'.

\(fn)" t nil)

(nxhtml-autoload 'jsut-jquery-mk-bookmarklet `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/js-utils" nxhtml-install-dir) "\
...
(nxhtml-autoload 'jsut-jquery-css-to-js `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/js-utils" nxhtml-install-dir) "\
...
(nxhtml-autoload 'key-cat-help `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/key-cat" nxhtml-install-dir) "\
...
(nxhtml-autoload 'majmodpri-sort-lists `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/majmodpri" nxhtml-install-dir) "\
...
(nxhtml-autoload 'majmodpri-apply `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/majmodpri" nxhtml-install-dir) "\
...
(nxhtml-autoload 'majmodpri-apply-priorities `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/majmodpri" nxhtml-install-dir) "\
...
(let ((loads (get 'majmodpri 'custom-loads))) (if (member '"../../../../../.emacs.d/lisp/nxhtml/util/majmodpri" loads) nil (put 'majmodpri 'custom-loads (cons '"../../../../../.emacs.d/lisp/nxhtml/util/majmodpri" loads))))
...
(let ((loads (get 'markchars 'custom-loads))) (if (member '"../../../../../.emacs.d/lisp/nxhtml/util/markchars" loads) nil (put 'markchars 'custom-loads (cons '"../../../../../.emacs.d/lisp/nxhtml/util/markchars" loads))))

(nxhtml-autoload 'markchars-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/markchars" nxhtml-install-dir) "\
...
(nxhtml-custom-autoload 'markchars-global-mode '../../../../../.emacs.d/lisp/nxhtml/util/markchars nil)

(nxhtml-autoload 'markchars-global-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/markchars" nxhtml-install-dir) "\
...
(let ((loads (get 'mlinks 'custom-loads))) (if (member '"../../../../../.emacs.d/lisp/nxhtml/util/mlinks" loads) nil (put 'mlinks 'custom-loads (cons '"../../../../../.emacs.d/lisp/nxhtml/util/mlinks" loads))))

(nxhtml-autoload 'mlinks-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mlinks" nxhtml-install-dir) "\
...
(nxhtml-custom-autoload 'mlinks-global-mode '../../../../../.emacs.d/lisp/nxhtml/util/mlinks nil)

(nxhtml-autoload 'mlinks-global-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mlinks" nxhtml-install-dir) "\
...
(nxhtml-autoload 'define-mumamo-multi-major-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo" nxhtml-install-dir) "\
...
(let ((loads (get 'mumamo 'custom-loads))) (if (member '"../../../../../.emacs.d/lisp/nxhtml/util/mumamo" loads) nil (put 'mumamo 'custom-loads (cons '"../../../../../.emacs.d/lisp/nxhtml/util/mumamo" loads))))

(let ((loads (get 'mumamo-hi-lock-faces 'custom-loads))) (if (member '"../../../../../.emacs.d/lisp/nxhtml/util/mumamo" loads) nil (put 'mumamo-hi-lock-faces 'custom-loads (cons '"../../../../../.emacs.d/lisp/nxhtml/util/mumamo" loads))))

(nxhtml-autoload 'mumamo-mark-for-refontification `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo" nxhtml-install-dir) "\
Mark region between MIN and MAX for refontification.

\(fn MIN MAX)" nil nil)

(nxhtml-autoload 'mumamo-list-defined-multi-major-modes `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo" nxhtml-install-dir) "\
...
(nxhtml-autoload 'mumamo-guess-multi-major `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo" nxhtml-install-dir) "\
...
(nxhtml-autoload 'mumamo-multi-major-modep `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo" nxhtml-install-dir) "\
...
(nxhtml-autoload 'mumamo-define-html-file-wide-keys `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo-chunks" nxhtml-install-dir) "\
Define keys in multi major mode keymap for html files.

\(fn)" nil nil)

(let ((loads (get 'mumamo-noweb2 'custom-loads))) (if (member '"../../../../../.emacs.d/lisp/nxhtml/util/mumamo-chunks" loads) nil (put 'mumamo-noweb2 'custom-loads (cons '"../../../../../.emacs.d/lisp/nxhtml/util/mumamo-chunks" loads))))
...
(nxhtml-autoload 'mumamo-cmirr-get-mirror `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo-cmirr" nxhtml-install-dir) "\
Get the mirror rec.
...
(nxhtml-autoload 'html-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo-fun" nxhtml-install-dir) "\
Turn on multiple major modes for (X)HTML with main mode `html-mode'.
This covers inlined style and javascript and PHP." t)

(nxhtml-autoload 'nxml-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo-fun" nxhtml-install-dir) "\
Turn on multiple major modes for (X)HTML with main mode `nxml-mode'.
This covers inlined style and javascript and PHP.

See also `mumamo-alt-php-tags-mode'." t)

(nxhtml-autoload 'mason-html-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo-fun" nxhtml-install-dir) "\
Turn on multiple major modes for Mason using main mode `html-mode'.
This covers inlined style and javascript." t)

(nxhtml-autoload 'embperl-html-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo-fun" nxhtml-install-dir) "\
Turn on multiple major modes for Embperl files with main mode `html-mode'.
This also covers inlined style and javascript." t)

(nxhtml-autoload 'django-html-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo-fun" nxhtml-install-dir) "\
Turn on multiple major modes for Django with main mode `html-mode'.
This also covers inlined style and javascript." t)

(nxhtml-autoload 'genshi-html-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo-fun" nxhtml-install-dir) "\
Turn on multiple major modes for Genshi with main mode `html-mode'.
This also covers inlined style and javascript." t)

(nxhtml-autoload 'mjt-html-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo-fun" nxhtml-install-dir) "\
Turn on multiple major modes for MJT with main mode `html-mode'.
This also covers inlined style and javascript." t)

(nxhtml-autoload 'smarty-html-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo-fun" nxhtml-install-dir) "\
Turn on multiple major modes for Smarty with main mode `html-mode'.
This also covers inlined style and javascript." t)

(nxhtml-autoload 'ssjs-html-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo-fun" nxhtml-install-dir) "\
Turn on multiple major modes for SSJS with main mode `html-mode'.
This covers inlined style and javascript." t)

(nxhtml-autoload 'gsp-html-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo-fun" nxhtml-install-dir) "\
Turn on multiple major modes for GSP with main mode `html-mode'.
This also covers inlined style and javascript." t)

(nxhtml-autoload 'jsp-html-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo-fun" nxhtml-install-dir) "\
Turn on multiple major modes for JSP with main mode `html-mode'.
This also covers inlined style and javascript." t)

(nxhtml-autoload 'eruby-html-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo-fun" nxhtml-install-dir) "\
...
(nxhtml-autoload 'eruby-javascript-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo-fun" nxhtml-install-dir) "\
Turn on multiple major modes for eRuby with main mode `javascript-mode'." t)

(nxhtml-autoload 'sh-heredoc-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo-fun" nxhtml-install-dir) "\
Turn on multiple major modes for sh heredoc document.
See `mumamo-heredoc-modes' for how to specify heredoc major modes." t)

(nxhtml-autoload 'php-heredoc-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo-fun" nxhtml-install-dir) "\
Turn on multiple major modes for PHP heredoc document.
See `mumamo-heredoc-modes' for how to specify heredoc major modes." t)

(nxhtml-autoload 'perl-heredoc-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo-fun" nxhtml-install-dir) "\
Turn on multiple major modes for Perl heredoc document.
See `mumamo-heredoc-modes' for how to specify heredoc major modes." t)

(nxhtml-autoload 'cperl-heredoc-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo-fun" nxhtml-install-dir) "\
Turn on multiple major modes for Perl heredoc document.
See `mumamo-heredoc-modes' for how to specify heredoc major modes." t)

(nxhtml-autoload 'python-heredoc-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo-fun" nxhtml-install-dir) "\
Turn on multiple major modes for Python heredoc document.
See `mumamo-heredoc-modes' for how to specify heredoc major modes." t)

(nxhtml-autoload 'ruby-heredoc-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo-fun" nxhtml-install-dir) "\
Turn on multiple major modes for Ruby heredoc document.
See `mumamo-heredoc-modes' for how to specify heredoc major modes." t)

(nxhtml-autoload 'metapost-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo-fun" nxhtml-install-dir) "\
Turn on multiple major modes for MetaPost." t)

(nxhtml-autoload 'laszlo-nxml-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo-fun" nxhtml-install-dir) "\
Turn on multiple major modes for OpenLaszlo." t)

(nxhtml-autoload 'csound-sgml-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo-fun" nxhtml-install-dir) "\
Turn on mutiple major modes for CSound orc/sco Modes." t)

(nxhtml-autoload 'noweb2-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo-fun" nxhtml-install-dir) "\
Multi major mode for noweb files." t)

(nxhtml-autoload 'tt-html-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo-fun" nxhtml-install-dir) "\
Turn on multiple major modes for TT files with main mode `nxhtml-mode'.
TT = Template-Toolkit.

This also covers inlined style and javascript." t)

(nxhtml-autoload 'asp-html-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo-fun" nxhtml-install-dir) "\
Turn on multiple major modes for ASP with main mode `html-mode'.
This also covers inlined style and javascript." t)

(nxhtml-autoload 'org-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo-fun" nxhtml-install-dir) "\
...
(nxhtml-autoload 'mako-html-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo-fun" nxhtml-install-dir) "\
Turn on multiple major modes for Mako with main mode `html-mode'.
This also covers inlined style and javascript." t)

(nxhtml-autoload 'xsl-nxml-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo-fun" nxhtml-install-dir) "\
Turn on multi major mode for XSL with main mode `nxml-mode'.
This covers inlined style and javascript." t)

(nxhtml-autoload 'xsl-sgml-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo-fun" nxhtml-install-dir) "\
Turn on multi major mode for XSL with main mode `sgml-mode'.
This covers inlined style and javascript." t)

(nxhtml-autoload 'markdown-html-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo-fun" nxhtml-install-dir) "\
...
(nxhtml-autoload 'latex-clojure-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo-fun" nxhtml-install-dir) "\
...
(nxhtml-autoload 'latex-haskell-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo-fun" nxhtml-install-dir) "\
...
(nxhtml-autoload 'python-rst-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo-fun" nxhtml-install-dir) "\
Turn on multiple major modes for Python with RestructuredText docstrings." t)

(nxhtml-autoload 'amrita-mumamo-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo-fun" nxhtml-install-dir) "\
...
(nxhtml-autoload 'mumamo-add-region `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo-regions" nxhtml-install-dir) "\
...
(nxhtml-autoload 'mumamo-add-region-from-string `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/mumamo-regions" nxhtml-install-dir) "\
...
(let ((loads (get 'n-back 'custom-loads))) (if (member '"../../../../../.emacs.d/lisp/nxhtml/util/n-back" loads) nil (put 'n-back 'custom-loads (cons '"../../../../../.emacs.d/lisp/nxhtml/util/n-back" loads))))

(nxhtml-autoload 'n-back-game `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/n-back" nxhtml-install-dir) "\
Emacs n-Back game.
...
(nxhtml-autoload 'rng-find-schema-file `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/nxml-mode-os-additions" nxhtml-install-dir) "\
Edit the current schema file.

\(fn)" t nil)

(nxhtml-autoload 'rng-find-schema-file-other-frame `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/nxml-mode-os-additions" nxhtml-install-dir) "\
Edit the current schema in another frame.

\(fn)" t nil)

(nxhtml-autoload 'rng-find-schema-file-other-window `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/nxml-mode-os-additions" nxhtml-install-dir) "\
...
(nxhtml-autoload 'ocr-user-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ocr-user" nxhtml-install-dir) "\
...
(nxhtml-autoload 'orgfl-find-links-in-org-buffers `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/org-find-links" nxhtml-install-dir) "\
...
(nxhtml-autoload 'orgfl-find-links-in-org-files `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/org-find-links" nxhtml-install-dir) "\
...
(nxhtml-autoload 'ourcomments-indirect-fun `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
Get the alias symbol for function FUN if any.

\(fn FUN)" nil nil)

(nxhtml-autoload 'popup-menu-at-point `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
...
(nxhtml-autoload 'define-toggle `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
...
(nxhtml-autoload 'unfill-paragraph `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
Unfill the current paragraph.

\(fn)" t nil)

(nxhtml-autoload 'unfill-region `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
Unfill the current region.

\(fn)" t nil)

(nxhtml-autoload 'unfill-individual-paragraphs `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
Unfill individual paragraphs in the current region.

\(fn)" t nil)

(nxhtml-autoload 'fill-dwim `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
Fill or unfill paragraph or region.
With prefix ARG fill only current line.

\(fn ARG)" t nil)

(nxhtml-autoload 'ourcomments-mark-whole-buffer-or-field `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
Mark whole buffer or editable field at point.

\(fn)" t nil)

(nxhtml-autoload 'major-or-multi-majorp `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
Return t if VALUE is a major or multi major mode function.

\(fn VALUE)" nil nil)

(nxhtml-autoload 'major-modep `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
Return t if VALUE is a major mode function.

\(fn VALUE)" nil nil)

(nxhtml-autoload 'ourcomments-move-beginning-of-line `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
...
(nxhtml-autoload 'ourcomments-move-end-of-line `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
...
(nxhtml-autoload 'describe-key-and-map-briefly `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
...
(nxhtml-custom-autoload 'better-fringes-mode '../../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util nil)

(nxhtml-autoload 'better-fringes-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
Choose another fringe bitmap color and bottom angle.

\(fn &optional ARG)" t nil)

(nxhtml-autoload 'ourcomments-copy+paste-set-point `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
...
(nxhtml-autoload 'ourcomments-browse-bug `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
Display emacs bug number EMACS-BUG in browser.

\(fn EMACS-BUG)" t nil)

(nxhtml-autoload 'ourcomments-tr `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
...
(nxhtml-autoload 'ourcomments-is-obsolete `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
Return non-nil if SYMBOL is obsolete in current Emacs.

\(fn SYMBOL)" nil nil)

(nxhtml-autoload 'paste-as-new-buffer `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
Paste from clipboard to a new buffer.

\(fn)" t nil)

(nxhtml-autoload 'describe-timers `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
Show timers with readable time format.

\(fn)" t nil)

(nxhtml-autoload 'ourcomments-insert-date-and-time `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
...
(nxhtml-autoload 'ediff-emacs-other-file `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
Ediff installed and source Emacs lisp file.
Works like `find-emacs-other-file' but also starts ediff.

\(fn)" t nil)

(nxhtml-autoload 'find-emacs-other-file `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
...
(nxhtml-autoload 'ourcomments-ediff-files `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
...
(nxhtml-autoload 'describe-command `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
Like `describe-function', but prompts only for interactive commands.

\(fn COMMAND)" t nil)

(nxhtml-autoload 'buffer-narrowed-p `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
Return non-nil if the current buffer is narrowed.

\(fn)" nil nil)

(nxhtml-autoload 'narrow-to-comment `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
Narrow to current comments.

\(fn)" t nil)

(nxhtml-autoload 'narrow-to-defun+comments-above `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
Like `narrow-to-defun' but include comments above.
See also `widen-to-comments-above'.

\(fn)" t nil)

(nxhtml-autoload 'widen-to-comments-above `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
Widen to include comments above current narrowing.
See also `narrow-to-defun+comments-above'.

\(fn)" t nil)

(nxhtml-autoload 'describe-custom-group `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
Describe customization group SYMBOL.

\(fn SYMBOL)" t nil)

(nxhtml-autoload 'describe-defstruct `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\


\(fn SYMBOL)" t nil)

(nxhtml-autoload 'describe-symbol `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
...
(nxhtml-autoload 'ourcomments-ido-buffer-other-window `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
Show buffer in other window.

\(fn)" t nil)

(nxhtml-autoload 'ourcomments-ido-buffer-other-frame `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
Show buffer in other frame.

\(fn)" t nil)

(nxhtml-autoload 'ourcomments-ido-buffer-raise-frame `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
...
(nxhtml-custom-autoload 'ourcomments-ido-ctrl-tab '../../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util nil)

(nxhtml-autoload 'ourcomments-ido-ctrl-tab `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
...
(nxhtml-autoload 'emacs-restart `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
Restart Emacs and start `server-mode' if on before.

\(fn)" t nil)

(nxhtml-autoload 'emacs `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
...
(nxhtml-autoload 'emacs-buffer-file `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
...
(nxhtml-autoload 'emacs--debug-init `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
Start a new Emacs with --debug-init parameter.
This calls the function `emacs' with added arguments ARGS.

\(fn &rest ARGS)" t nil)

(nxhtml-autoload 'emacs--no-desktop `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
Start a new Emacs with --no-desktop parameter.
This calls the function `emacs' with added arguments ARGS.

\(fn &rest ARGS)" t nil)

(nxhtml-autoload 'emacs-Q `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
...
(nxhtml-autoload 'emacs-Q-nxhtml `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
Start new Emacs with -Q and load nXhtml.
This calls the function `emacs' with added arguments ARGS.

\(fn &rest ARGS)" t nil)

(nxhtml-autoload 'grep-query-replace `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
...
(nxhtml-autoload 'ldir-query-replace `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
...
(nxhtml-autoload 'rdir-query-replace `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
...
(nxhtml-autoload 'replace-read-files `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
Read files arg for replace.

\(fn REGEXP &optional REPLACE)" nil nil)

(nxhtml-autoload 'info-open-file `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
Open an info file in `Info-mode'.

\(fn INFO-FILE)" t nil)

(nxhtml-autoload 'use-custom-style `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
Setup like in `Custom-mode', but without things specific to Custom.

\(fn)" nil nil)

(nxhtml-autoload 'org-copy-url `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
...
(nxhtml-custom-autoload 'ourcomments-paste-with-convert-mode '../../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util nil)

(nxhtml-autoload 'ourcomments-paste-with-convert-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
...
(nxhtml-custom-autoload 'ourcomments-M-x-menu-mode '../../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util nil)

(nxhtml-autoload 'ourcomments-M-x-menu-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
...
(nxhtml-autoload 'ourcomments-warning `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\


\(fn FORMAT-STRING &rest ARGS)" nil nil)

(nxhtml-autoload 'ourcomments-bounds-of-string-at-point `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
Return bounds of string at point if any.

\(fn)" nil nil)

(nxhtml-autoload 'ourcomments-bounds-of-comment-at-point `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
Return bounds of comment at point if any.

\(fn)" nil nil)

(nxhtml-autoload 'ourcomments-bounds-of-string-or-comment-at-point `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
Return bounds of string or comment at point if any.

\(fn)" nil nil)

(nxhtml-autoload 'org-freemind-copy-new-marktree\.js `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/ourcomments-util" nxhtml-install-dir) "\
...
(let ((loads (get 'pause 'custom-loads))) (if (member '"../../../../../.emacs.d/lisp/nxhtml/util/pause" loads) nil (put 'pause 'custom-loads (cons '"../../../../../.emacs.d/lisp/nxhtml/util/pause" loads))))
...
(nxhtml-custom-autoload 'pause-mode '../../../../../.emacs.d/lisp/nxhtml/util/pause nil)

(nxhtml-autoload 'pause-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/pause" nxhtml-install-dir) "\
...
(nxhtml-autoload 'pause-start-in-new-emacs `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/pause" nxhtml-install-dir) "\
...
(nxhtml-autoload 'pointback-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/pointback" nxhtml-install-dir) "\
...
(nxhtml-custom-autoload 'global-pointback-mode '../../../../../.emacs.d/lisp/nxhtml/util/pointback nil)

(nxhtml-autoload 'global-pointback-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/pointback" nxhtml-install-dir) "\
...
(let ((loads (get 'popcmp 'custom-loads))) (if (member '"../../../../../.emacs.d/lisp/nxhtml/util/popcmp" loads) nil (put 'popcmp 'custom-loads (cons '"../../../../../.emacs.d/lisp/nxhtml/util/popcmp" loads))))
...
(nxhtml-custom-autoload 'popcmp-completion-style '../../../../../.emacs.d/lisp/nxhtml/util/popcmp nil)

(nxhtml-autoload 'popcmp-completing-read `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/popcmp" nxhtml-install-dir) "\
...
(let ((loads (get 'rebind 'custom-loads))) (if (member '"../../../../../.emacs.d/lisp/nxhtml/util/rebind" loads) nil (put 'rebind 'custom-loads (cons '"../../../../../.emacs.d/lisp/nxhtml/util/rebind" loads))))
...
(nxhtml-custom-autoload 'rebind-keys-mode '../../../../../.emacs.d/lisp/nxhtml/util/rebind nil)

(nxhtml-autoload 'rebind-keys-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/rebind" nxhtml-install-dir) "\
...
(nxhtml-autoload 'rnc-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/rnc-mode" nxhtml-install-dir) "\
...
(nxhtml-autoload 'rtmpdump-from-url `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/rtmpdump" nxhtml-install-dir) "\


\(fn URL)" t nil)

(nxhtml-autoload 'rtmpdump-from-buffer `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/rtmpdump" nxhtml-install-dir) "\


\(fn BUF)" t nil)

(nxhtml-autoload 'rtmpdump-from-file `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/rtmpdump" nxhtml-install-dir) "\
...
(nxhtml-autoload 'rxx-parse-string `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/rxx" nxhtml-install-dir) "\
...
(nxhtml-autoload 'rxx-simplify-result `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/rxx" nxhtml-install-dir) "\
...
(nxhtml-autoload 'rxx-parse `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/rxx" nxhtml-install-dir) "\
...
(nxhtml-autoload 'search-form `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/search-form" nxhtml-install-dir) "\
...
(nxhtml-autoload 'search-net-dwim `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/search-net" nxhtml-install-dir) "\


\(fn)" t nil)

(nxhtml-autoload 'search-net `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/search-net" nxhtml-install-dir) "\
...
(let ((loads (get 'sex 'custom-loads))) (if (member '"../../../../../.emacs.d/lisp/nxhtml/util/sex-mode" loads) nil (put 'sex 'custom-loads (cons '"../../../../../.emacs.d/lisp/nxhtml/util/sex-mode" loads))))
...
(nxhtml-custom-autoload 'sex-mode '../../../../../.emacs.d/lisp/nxhtml/util/sex-mode nil)

(nxhtml-autoload 'sex-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/sex-mode" nxhtml-install-dir) "\
...
(let ((loads (get 'sml-modeline 'custom-loads))) (if (member '"../../../../../.emacs.d/lisp/nxhtml/util/sml-modeline" loads) nil (put 'sml-modeline 'custom-loads (cons '"../../../../../.emacs.d/lisp/nxhtml/util/sml-modeline" loads))))
...
(nxhtml-custom-autoload 'sml-modeline-mode '../../../../../.emacs.d/lisp/nxhtml/util/sml-modeline nil)

(nxhtml-autoload 'sml-modeline-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/sml-modeline" nxhtml-install-dir) "\
...
(let ((loads (get 'tabkey2 'custom-loads))) (if (member '"../../../../../.emacs.d/lisp/nxhtml/util/tabkey2" loads) nil (put 'tabkey2 'custom-loads (cons '"../../../../../.emacs.d/lisp/nxhtml/util/tabkey2" loads))))
...
(nxhtml-custom-autoload 'tabkey2-mode '../../../../../.emacs.d/lisp/nxhtml/util/tabkey2 nil)

(nxhtml-autoload 'tabkey2-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/tabkey2" nxhtml-install-dir) "\
...
(nxhtml-autoload 'tabkey2-emma-without-tabkey2 `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/tabkey2" nxhtml-install-dir) "\
...
(nxhtml-autoload 'udev-call-first-step `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/udev" nxhtml-install-dir) "\
...
(nxhtml-autoload 'udev-ecb-update `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/udev-ecb" nxhtml-install-dir) "\
...
(nxhtml-autoload 'udev-ecb-customize-startup `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/udev-ecb" nxhtml-install-dir) "\
...
(nxhtml-autoload 'udev-rinari-update `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/udev-rinari" nxhtml-install-dir) "\
...
(nxhtml-autoload 'viper-tutorial `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/viper-tut" nxhtml-install-dir) "\
...
(nxhtml-autoload 'vline-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/vline" nxhtml-install-dir) "\
...
(nxhtml-custom-autoload 'vline-global-mode '../../../../../.emacs.d/lisp/nxhtml/util/vline nil)

(nxhtml-autoload 'vline-global-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/vline" nxhtml-install-dir) "\
...
(nxhtml-autoload 'web-vcs-linkpatt-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/web-vcs-linkpatt" nxhtml-install-dir) "\
...
(let ((loads (get 'whelp 'custom-loads))) (if (member '"../../../../../.emacs.d/lisp/nxhtml/util/whelp" loads) nil (put 'whelp 'custom-loads (cons '"../../../../../.emacs.d/lisp/nxhtml/util/whelp" loads))))
...
(nxhtml-autoload 'winsav-put-window-tree `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/winsav" nxhtml-install-dir) "\
...
(let ((loads (get 'winsav 'custom-loads))) (if (member '"../../../../../.emacs.d/lisp/nxhtml/util/winsav" loads) nil (put 'winsav 'custom-loads (cons '"../../../../../.emacs.d/lisp/nxhtml/util/winsav" loads))))
...
(nxhtml-custom-autoload 'winsav-save-mode '../../../../../.emacs.d/lisp/nxhtml/util/winsav nil)

(nxhtml-autoload 'winsav-save-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/winsav" nxhtml-install-dir) "\
...
(nxhtml-autoload 'winsav-save-full-config `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/winsav" nxhtml-install-dir) "\
...
(nxhtml-autoload 'winsav-switch-config `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/winsav" nxhtml-install-dir) "\
...
(nxhtml-autoload 'resize-windows `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/winsize" nxhtml-install-dir) "\
...
(nxhtml-autoload 'winsize-fit-window-to-desired-width `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/winsize" nxhtml-install-dir) "\
...
(nxhtml-autoload 'winsize-fit-window-to-buffer `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/winsize" nxhtml-install-dir) "\
...
(nxhtml-autoload 'winsize-fit-windows-to-desired-widths `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/winsize" nxhtml-install-dir) "\
...
(nxhtml-autoload 'winsize-max-frame-height `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/winsize" nxhtml-install-dir) "\
Maximize frame height.

\(fn)" t nil)

(nxhtml-autoload 'winsize-fitw-and-maxh-frame `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/winsize" nxhtml-install-dir) "\
Fit width and max height of frame.
Just like `winsize-fit-frame-width' + `winsize-max-frame-height'.

\(fn)" t nil)

(nxhtml-autoload 'winsize-fit-frame-width `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/winsize" nxhtml-install-dir) "\
...
(nxhtml-autoload 'winsize-balance-siblings `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/winsize" nxhtml-install-dir) "\
...
(nxhtml-autoload 'winsize-save-window-configuration `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/winsize" nxhtml-install-dir) "\


\(fn)" t nil)

(nxhtml-autoload 'winsize-set-mode-line-colors `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/winsize" nxhtml-install-dir) "\
Turn mode line colors on if ON is non-nil, otherwise off.

\(fn ON)" nil nil)

(nxhtml-autoload 'winsav-rotate `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/winsize" nxhtml-install-dir) "\
...
(let ((loads (get 'wrap-to-fill 'custom-loads))) (if (member '"../../../../../.emacs.d/lisp/nxhtml/util/wrap-to-fill" loads) nil (put 'wrap-to-fill 'custom-loads (cons '"../../../../../.emacs.d/lisp/nxhtml/util/wrap-to-fill" loads))))
...
(nxhtml-custom-autoload 'wrap-to-fill-left-marg '../../../../../.emacs.d/lisp/nxhtml/util/wrap-to-fill t)

(defvar wrap-to-fill-left-marg-modes '(text-mode fundamental-mode) "\
Major modes where `wrap-to-fill-left-marg' may be nil.")

(nxhtml-custom-autoload 'wrap-to-fill-left-marg-modes '../../../../../.emacs.d/lisp/nxhtml/util/wrap-to-fill t)

(nxhtml-autoload 'wrap-to-fill-column-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/wrap-to-fill" nxhtml-install-dir) "\
...
(let ((loads (get 'zencoding 'custom-loads))) (if (member '"../../../../../.emacs.d/lisp/nxhtml/util/zencoding-mode" loads) nil (put 'zencoding 'custom-loads (cons '"../../../../../.emacs.d/lisp/nxhtml/util/zencoding-mode" loads))))

(nxhtml-autoload 'zencoding-expand-line `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/zencoding-mode" nxhtml-install-dir) "\
...
(nxhtml-autoload 'zencoding-mode `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/zencoding-mode" nxhtml-install-dir) "\
...
(nxhtml-autoload 'zencoding-expand-yas `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/zencoding-mode" nxhtml-install-dir) "\


\(fn)" t nil)

(nxhtml-autoload 'zencoding-preview `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/util/zencoding-mode" nxhtml-install-dir) "\
...
(nxhtml-autoload 'web-vcs-default-download-directory `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/web-vcs" nxhtml-install-dir) "\
...
(nxhtml-autoload 'web-vcs-log-edit `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/web-vcs" nxhtml-install-dir) "\
Open log file.

\(fn)" t nil)

(nxhtml-autoload 'web-vcs-get-files-from-root `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/web-vcs" nxhtml-install-dir) "\
...
(nxhtml-autoload 'web-vcs-message-with-face `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/web-vcs" nxhtml-install-dir) "\
...
(nxhtml-autoload 'web-vcs-byte-compile-file `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/web-vcs" nxhtml-install-dir) "\
...
(nxhtml-autoload 'web-vcs-url-retrieve-synch `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/web-vcs" nxhtml-install-dir) "\
Retrieve URL, return cons with buffer and http status.

\(fn URL)" nil nil)

(nxhtml-autoload 'web-vcs-url-copy-file `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/web-vcs" nxhtml-install-dir) "\
...
(nxhtml-autoload 'web-vcs-investigate-elisp-file `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/web-vcs" nxhtml-install-dir) "\
...
;;;***

;;;### (autoloads nil nil ("../../../../.emacs.d/lisp/nxhtml/autostart.el"
;;;;;;  "../../../../.emacs.d/lisp/nxhtml/autostart22.el" "../../../../.emacs.d/lisp/nxhtml/etc/schema/schema-path-patch.el"
;;;;;;  "../../../../.emacs.d/lisp/nxhtml/nxhtml-base.el" "../../../../.emacs.d/lisp/nxhtml/nxhtml/html-imenu.el"
;;;;;;  "../../../../.emacs.d/lisp/nxhtml/nxhtml/html-move.el" "../../../../.emacs.d/lisp/nxhtml/nxhtml/html-quote.el"
;;;;;;  "../../../../.emacs.d/lisp/nxhtml/nxhtml/nxhtml-autoload.el"
;;;;;;  "../../../../.emacs.d/lisp/nxhtml/nxhtml/nxhtml-strval.el"
;;;;;;  "../../../../.emacs.d/lisp/nxhtml/nxhtml/nxhtmljs.el" "../../../../.emacs.d/lisp/nxhtml/nxhtml/outline-magic.el"
;;;;;;  "../../../../.emacs.d/lisp/nxhtml/nxhtml/wtest.el" "../../../../.emacs.d/lisp/nxhtml/related/flymake-for-css.el"
;;;;;;  "../../../../.emacs.d/lisp/nxhtml/related/flymake-for-el.el"
;;;;;;  "../../../../.emacs.d/lisp/nxhtml/related/flymake-for-java.el"
;;;;;;  "../../../../.emacs.d/lisp/nxhtml/related/flymake-for-rb.el"
;;;;;;  "../../../../.emacs.d/lisp/nxhtml/related/flymake-helpers.el"
;;;;;;  "../../../../.emacs.d/lisp/nxhtml/related/flymakemsg.el"
;;;;;;  "../../../../.emacs.d/lisp/nxhtml/related/php-imenu.el" "../../../../.emacs.d/lisp/nxhtml/tests/angus77-setup-jde.el"
;;;;;;  "../../../../.emacs.d/lisp/nxhtml/tests/emacstest-suites.el"
;;;;;;  "../../../../.emacs.d/lisp/nxhtml/tests/ertn2.el" "../../../../.emacs.d/lisp/nxhtml/tests/hfy-test.el"
;;;;;;  "../../../../.emacs.d/lisp/nxhtml/tests/inemacs/bug1013.el"
;;;;;;  "../../../../.emacs.d/lisp/nxhtml/tests/mumamo-test.el" "../../../../.emacs.d/lisp/nxhtml/tests/nxhtmltest-helpers.el"
;;;;;;  "../../../../.emacs.d/lisp/nxhtml/tests/temp-test.el" "../../../../.emacs.d/lisp/nxhtml/util/ack.el"
;;;;;;  "../../../../.emacs.d/lisp/nxhtml/util/appmenu-fold.el" "../../../../.emacs.d/lisp/nxhtml/util/backtr.el"
;;;;;;  "../../../../.emacs.d/lisp/nxhtml/util/css-simple-completion.el"
;;;;;;  "../../../../.emacs.d/lisp/nxhtml/util/custsets.el" "../../../../.emacs.d/lisp/nxhtml/util/ecb-batch-compile.el"
;;;;;;  "../../../../.emacs.d/lisp/nxhtml/util/fun.el" "../../../../.emacs.d/lisp/nxhtml/util/fupd.el"
;;;;;;  "../../../../.emacs.d/lisp/nxhtml/util/idn.el" "../../../../.emacs.d/lisp/nxhtml/util/mumamo-trace.el"
;;;;;;  "../../../../.emacs.d/lisp/nxhtml/util/new-key-seq-widget.el"
;;;;;;  "../../../../.emacs.d/lisp/nxhtml/util/org-odt.el" "../../../../.emacs.d/lisp/nxhtml/util/org-panel.el"
...
(nxhtml-autoload 'nxhtml-setup-install `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml-web-vcs" nxhtml-install-dir) "\
...
(nxhtml-autoload 'nxhtml-setup-auto-download `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml-web-vcs" nxhtml-install-dir) "\
...
(nxhtml-autoload 'nxhtml-setup-download-all `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml-web-vcs" nxhtml-install-dir) "\
...
(nxhtml-autoload 'nxhtml-update-existing-files `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml-web-vcs" nxhtml-install-dir) "\
...
(nxhtml-autoload 'nxhtml-get-missing-files `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml-web-vcs" nxhtml-install-dir) "\
...
(nxhtml-autoload 'nxhtml-byte-compile-file `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml-web-vcs" nxhtml-install-dir) "\


\(fn FILE &optional LOAD)" nil nil)

(nxhtml-autoload 'nxhtml-byte-recompile-file `(lp '(nxhtml-download-root-url nil) "../../../../.emacs.d/lisp/nxhtml/nxhtml-web-vcs" nxhtml-install-dir) "\
